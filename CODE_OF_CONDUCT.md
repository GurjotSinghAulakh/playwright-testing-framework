...
1. **Correction**  
   Private, written warning about the behavior, why it violates this Code of Conduct, and consequences if it continues.

2. **Warning**  
   A warning with consequences for continued behavior, potentially including restrictions on interaction in the community.

3. **Temporary Ban**  
   Temporary ban from community interaction for a specified period of time.
